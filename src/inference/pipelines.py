...
from ..models.vae_models import ShapeVAE
from ..model_components.autoencoders import SurfaceExtractors
from ..model_components.utils import logger, synchronize_timer, smart_load_model
    ...
    def __call__(
        ...
        with synchronize_timer('Diffusion Sampling'):
            for i, t in enumerate(
                    tqdm(timesteps, disable=not enable_pbar, desc="Diffusion Sampling:", leave=False)):
    ...
    def __call__(
        ...
        with synchronize_timer('Diffusion Sampling'):
            for i, t in enumerate(tqdm(timesteps, disable=not enable_pbar, desc="Diffusion Sampling:")):
                ...
                # print('>' * 20, f"noise_pred: {noise_pred}")
