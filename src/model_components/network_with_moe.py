...
from src.model_components.simple_module_with_moe import TimePointWiseEncoder, TimestepEmbedder

from src.model_components.transformer_with_moe import (
    ...
    def _build_model(self):
        ...
        if self.hparams.encoder_type == "transformer":
            self.encoder = TimeTransformerEncoder(
                ...
                last_fc=False,
                num_moe_layers=self.hparams.get("enc_num_moe_layers"),
                num_experts=self.hparams.get("enc_num_experts"),
                use_swiglu=self.hparams.get("use_swiglu"),
            )
        ...
        if self.hparams.decoder_type == "transformer_decoder":
            self.decoder = TimeTransformerDecoder(
                ...
                num_moe_layers=self.hparams.get("dec_num_moe_layers"),
                num_experts=self.hparams.get("dec_num_experts"),
                use_swiglu=self.hparams.get("use_swiglu"),
            )
