...
from src.model_components.transformer_with_moe import TimeMLP
...
class TimePointwiseLayer(nn.Module):
    def __init__(
        ...
        if use_swiglu:
            ...
            self.mlp_swiglu = SwiGLUFFN(dim_in, int(2 / 3 * mlp_hidden_dim))
